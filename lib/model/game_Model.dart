...
class Game {
  ...
  factory Game.fromJson(Map<String, dynamic> json) {
    ...
    return Game(
      ...
      playtime: json['playtime'],
      genres: genres,
      // genres: json['genres'] != null ? List<String>.from(json['genres'].map((x) => x['name'])) : [],
      // platforms: json['platforms'] != null
      //     ? List<String>.from(json['platforms'].map((x) => x['name']))
      //     : [],
      // publishers: json['publishers'] != null
      //     ? List<String>.from(json['publishers'].map((x) => x['name']))
      //     : [],
